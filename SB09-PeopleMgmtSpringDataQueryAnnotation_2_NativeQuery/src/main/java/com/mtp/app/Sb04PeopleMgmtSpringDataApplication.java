...
public class Sb04PeopleMgmtSpringDataApplication implements CommandLineRunner {
	...
	private void getPersonInfoByFirstNameAndEmail() {
		List<Person> personList = peopleMgmtService.findByFirstNameAndEmail("Jitendra","jeet1.62.jp@gmail.com");
		personList.forEach(System.out::println);
	}

	private void getPersonsInfoByFirstName() {
		List<Person> personList = peopleMgmtService.getPersonInfoByFirstName("Jitendra");
		personList.forEach(System.out::println);
	}
